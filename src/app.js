...
class App {
  ...
  #setRoutes() {
    this.#routes = {
      ...
      server_resources: async () => { return await import('./components/server-resources/server-resources.js'); }, 
      app_monitoring: async () => { return await import('./components/app-monitoring/app-monitoring.js'); }, 
      app_logging: async () => { return await import('./components/app-logging/app-logging.js'); }, 
      app_resources: async () => { return await import('./components/app-resources/app-resources.js'); }, 
    };
  }
