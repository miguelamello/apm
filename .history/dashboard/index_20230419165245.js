...
import 'cirrus-ui';
import '@fortawesome/fontawesome-free/css/re.css';
...
(async () => {
  ...
  const fragment = `
    <div id="app-root" class="h-screen u-flex u-flex-column u-items-stretch">
      <div id="app-header" class="bg-gray-400 u-flex-grow-0"></div>
      <div id="app-body" class="bg-gray-200 u-flex-grow-1"></div>
    </div>
  `;
