...
class App {
  ...
  #setRoutes() {
    this.#routes = {
      ...
      server_logging: async () => { return await import('./components/server-logging/server-logging.js'); }, 
      server_resource: async () => { return await import('./components/server-logging/server-resource.js'); }, 
      app_monitoring: async () => { return await import('./components/server-monitoring/server-monitoring.js'); }, 
      app_logging: async () => { return await import('./components/server-logging/server-logging.js'); }, 
      app_resource: async () => { return await import('./components/server-logging/server-resource.js'); }, 
    };
  }
  ...
  // returns an observer previously setted
  getObserver(index) {
  ...
  // returns an instance of a route
  ...
  // appends a fragment to the body
  appendFragment( html ) {
