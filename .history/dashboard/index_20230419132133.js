...
(async () => {
  ...
  const fragment = `
    <div id="app-root" class="h-screen u-flex u-flex-column u-items-stretch">
      <div id="app-header" class="bg-blue-500 p-1 h-64 text-white u-flex-grow-0">header</div>
      <div id="app-body" class="bg-gray-500 p-1 text-white u-flex-grow-1">body</div>
    </div>
  `;
