...
class Toolbar {
  ...
  #bondToDom() {
    setTimeout(() => {
      ...
      this.#SMPanel = document.getElementById('4t9hltwq4x');
      this.#SLPanel = document.getElementById('4t9hltwq4x');
      this.#SRPanel = document.getElementById('4t9hltwq4x');
      this.#APPanel = document.getElementById('4t9hltwq4x');
      this.#ALPanel = document.getElementById('4t9hltwq4x');
      this.#ARPanel = document.getElementById('4t9hltwq4x');
      this.setListeners();
    });
  }
