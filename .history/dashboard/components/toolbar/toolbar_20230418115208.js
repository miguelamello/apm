...
class appToolbar extends React.Component {
  ...
  constructor() {
    ...
    this.setMenuVisibility = this.handleClick.bind(this);
  }
  ...
  setMenuVisibility() { console.log(this.state.menu.visible);
    /*this.state.menu.visible = false;
    console.log(this.state.menu.visible);*/
  }

  getTemplate() {  
    let self = this;
    let visible = this.state.menu.visible;
    return (
      <Box sx={{ flexGrow: 1 }}>
          ...
          <Toolbar>
            {
              visible && (
                <IconButton
                  ...
                  aria-label="menu"
                  sx={{ mr: 2 }} 
                  onClick={self.setMenuVisibility}
                >
                  <MenuIcon />
                </IconButton>
              )
