...
class Toolbar {
  ...
  #modalClose; // holds the modal close button
  ...
  #bondToDom() {
    setTimeout(() => {
      ...
      this.#modalClose = document.getElementById('0dnsghdw75-close');
      this.#modalConfirm = document.getElementById('0dnsghdw75-confirm');
      this.setListeners();
    });
  }
  ...
  openModal() { 
    ...
    anchor.click();*/
    this.#modal.classList.toggle('u-none');
  }
