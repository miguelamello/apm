...
class appToolbar extends React.Component {
  ...
  #menuItems() {
    return [
      'Application Response Time', 'Application Error Rate', 'CPU Usage', 'Memory Usage', 
      'Network Latency', 'Database Performance', 'Application Logging', 
      ''
    ];
  }
        ...
        <Box sx={{ display: 'flex' }}>
          <Drawer open={this.#state.menu.visible}>
            ...
            <Box sx={{ width: '100%', maxWidth: this.#menuItemWidth, bgcolor: 'background.paper' }}>
              {
                ['Response Time', 'Error Rate', 'CPU Usage', 'Memory Usage'].map((text, index) => () => {
                  return (
