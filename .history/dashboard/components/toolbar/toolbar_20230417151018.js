...
class Toolbar {
  ...
  #setTemplate() {
    //this.#template = (<div><Button variant="contained">Hello World</Button></div>);
  }
  ...
  getTemplate() {  
    ...
    return <Button variant="contained">Hello World</Button></div>);
  }
  ...
  load() {
    ...
    //this.#bondToDom();
    //ReactDOM.render(<Button variant="contained">Hello World</Button>, container);
  }
